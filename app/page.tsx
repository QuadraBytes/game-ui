  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-96 h-96 bg-rose-500/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {games.map((game, index) => (
            ...
            >
              <div
                className={`absolute inset-0 ${game.bgGlow} rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
              ></div>
              ...
              <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 transform group-hover:scale-105 group-hover:-translate-y-2 shadow-xl hover:shadow-2xl">
                <div
                  className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${game.gradient} rounded-2xl mb-6 shadow-lg group-hover:shadow-2xl transition-shadow duration-300`}
                >
                  <span className="text-4xl">{game.icon}</span>
                </div>

                <h2
                  className={`text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${game.gradient} mb-3`}
                >
                  {game.title}
                </h2>
                ...
                <div
                  className={`inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r ${game.gradient} text-white font-semibold rounded-xl shadow-lg group-hover:shadow-2xl transition-all duration-300 transform group-hover:scale-110`}
                >
                  <span>Play Now</span>
                </div>
